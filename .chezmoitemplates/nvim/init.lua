	...
	-- Handle dark/light mode automatically
	{
		...
		opts = {
			set_dark_mode = function()
				...
				local curr_scheme = vim.g.colors_name
				if curr_scheme == nil then
					curr_scheme = "{{ .theme }}"
				end
				if curr_scheme == "ayu" then
					vim.g.ayucolor = "mirage"
					vim.cmd.colorscheme("ayu")
				elseif curr_scheme == "NeoSolarized" or curr_scheme == "solarized" then
					reconfigNeosolarized(true)
				elseif string.starts(curr_scheme, "rose-pine") then
